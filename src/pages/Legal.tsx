        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <LegalCard
            ...
            description={
              <>
                <Paragraph>
                  KamiPlay functions as a search engine and content aggregator
                ...
                <Link to="/about">Learn more about how KamiPlay works</Link>
              </>
            }
          />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                KamiPlay is entirely self hostable, and can be run on any
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                KamiPlay is licensed under the MIT license.
                <br />
                <br />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                KamiPlay operates within legal boundaries and cooperates with
